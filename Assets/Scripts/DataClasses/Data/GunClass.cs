...
public enum WEAPON_EFFECT : byte
{
	...
	ANTI_AIRCRAFT,
	ALL_ROUNDER,
	NUMEFFECTS,			/**  The number of enumerators in this enum. */
};
...
/// </summary>
public class GunClass : BaseDataClass
{
	/// <summary>
	/// Тип подвески
	/// </summary>
	...
	/// </summary>
	public GunType weaponClass;
	/// <summary>
	/// the subclass to which the weapon belongs (research class)
	/// </summary>
	public GunType weaponSubClass;
	/// <summary>
	/// Periodical damage weapon class by damage type (KINETIC, HEAT)
	/// </summary>
	public GunType periodicalDamageWeaponClass;
	/// <summary>
	/// Periodical damage weapon subclass (research class)
	/// </summary>
	public GunType periodicalDamageWeaponSubClass;


	public Dictionary<GunEnums, int> values = new Dictionary<GunEnums, int>();
	public static Dictionary<GunEnums, int> maxValues = new Dictionary<GunEnums, int>();

	public GunClass()
	{}

	public GunClass(JsonObject pData)
	{
		Init (pData);
	}
	...
	public override void Init(JsonObject pData)
	{
		...
		values.Clear ();
		foreach (GunEnums e in System.Enum.GetValues(typeof(GunEnums)))
		{
	...
	/// </summary>
	public static GunType GetType(string pName)
	{
		try
		{
			return (GunType) System.Enum.Parse (typeof(GunType), pName.Replace("-","_").Replace(" ","_"));
		}
		catch 
		{
