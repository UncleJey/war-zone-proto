...
public enum BodyEnums : byte
{
	...
	,buildPower		= 2  //10
	/// <summary>
	/// Hit points (HP) are multiplied by produlsion HP modifier
	/// </summary>
	,hitpoints		= 3  //1
	/// <summary>
	/// Component's weight
...
public class BodyClass : BaseDataClass 
{
	...
	/// <summary>
	/// Size of body determines how much factory modules you need to produce this body (HEAVY - 3, MEDIUM - 2, LIGHT - 1)
	/// </summary>
